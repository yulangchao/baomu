...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2019 at 01:42 AM
...
(1, 'admin', 'Admin', '8ffbd506212a3bc252fec830e4aa9635', 'acb1b6', '/assets/img/avatar.png', 'arthurma124@gmail.com', 0, 1567646538, 1492186163, 1567646538, '22415a98-f81c-4366-9321-c7c53a0cb781', 'normal');
...
(1, 1, 'admin', '/index.php/admin/index/login', 'Login', '{"__token__":"29252ededcec8e86a76d6fa2be60e8d6","username":"admin","captcha":"TSNY"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567646538),
(2, 1, 'admin', '/index.php/admin/addon/local', '插件管理 本地安装', '{"name":"xshop1.0.0.zip"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567646760),
(3, 1, 'admin', '/index.php/admin/addon/state', '插件管理 禁用启用', '{"name":"xshop","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567646760),
(4, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567646760),
(5, 1, 'admin', '/index.php/admin/addon/local', '插件管理 本地安装', '{"name":"1.0.8.zip"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647126),
(6, 1, 'admin', '/index.php/admin/addon/state', '插件管理 禁用启用', '{"name":"example","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647126),
(7, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647127),
(8, 1, 'admin', '/index.php/admin/addon/state', '插件管理 禁用启用', '{"name":"example","action":"disable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647172),
(9, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647172),
(10, 1, 'admin', '/index.php/admin/addon/uninstall', '插件管理 卸载', '{"name":"example","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647176),
(11, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647176),
(12, 1, 'admin', '/index.php/admin/addon/local', '插件管理 本地安装', '{"name":"1.0.5.zip"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647236),
(13, 1, 'admin', '/index.php/admin/addon/state', '插件管理 禁用启用', '{"name":"epay","action":"enable","force":"0"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647236),
(14, 1, 'admin', '/index.php/admin/index/index', '', '{"action":"refreshmenu"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', 1567647236);
...
(85, 'file', 0, 'xshop', 'XShop商城', 'fa fa-list', '', '', 1, 1567646752, 1567646752, 0, 'normal'),
(86, 'file', 85, 'xshop/index', '控制台', 'fa fa-list', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(87, 'file', 86, 'xshop/index/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(88, 'file', 86, 'xshop/index/cityselector', '选择城市', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(89, 'file', 86, 'xshop/index/upload', '上传文件', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(90, 'file', 85, 'xshop/nav', '导航管理', 'fa fa-list', '', '', 1, 1567646752, 1567646752, 0, 'normal'),
(91, 'file', 90, 'xshop/nav/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(92, 'file', 90, 'xshop/nav/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(93, 'file', 90, 'xshop/nav/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(94, 'file', 90, 'xshop/nav/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(95, 'file', 90, 'xshop/nav/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(96, 'file', 85, 'xshop/category', '商品分类管理', 'fa fa-list', '', '', 1, 1567646752, 1567646752, 0, 'normal'),
(97, 'file', 96, 'xshop/category/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(98, 'file', 96, 'xshop/category/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(99, 'file', 96, 'xshop/category/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(100, 'file', 96, 'xshop/category/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(101, 'file', 96, 'xshop/category/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646752, 1567646752, 0, 'normal'),
(102, 'file', 85, 'xshop/product', '商品管理', 'fa fa-list', '', '', 1, 1567646752, 1567646752, 0, 'normal'),
(103, 'file', 102, 'xshop/product/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(104, 'file', 102, 'xshop/product/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(105, 'file', 102, 'xshop/product/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(106, 'file', 102, 'xshop/product/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(107, 'file', 102, 'xshop/product/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(108, 'file', 85, 'xshop/order', '订单管理', 'fa fa-list', '', '', 1, 1567646753, 1567646753, 0, 'normal'),
(109, 'file', 108, 'xshop/order/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(110, 'file', 108, 'xshop/order/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(111, 'file', 108, 'xshop/order/pay', '付款', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(112, 'file', 108, 'xshop/order/ship', '发货', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(113, 'file', 108, 'xshop/order/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(114, 'file', 108, 'xshop/order/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(115, 'file', 108, 'xshop/order/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(116, 'file', 85, 'xshop/unit', '记量单位管理', 'fa fa-list', '', '', 1, 1567646753, 1567646753, 0, 'normal'),
(117, 'file', 116, 'xshop/unit/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(118, 'file', 116, 'xshop/unit/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(119, 'file', 116, 'xshop/unit/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(120, 'file', 116, 'xshop/unit/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(121, 'file', 116, 'xshop/unit/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(122, 'file', 85, 'xshop/delivery', '运费模板管理', 'fa fa-list', '', '', 1, 1567646753, 1567646753, 0, 'normal'),
(123, 'file', 122, 'xshop/delivery/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(124, 'file', 122, 'xshop/delivery/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(125, 'file', 122, 'xshop/delivery/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(126, 'file', 122, 'xshop/delivery/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(127, 'file', 122, 'xshop/delivery/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(128, 'file', 85, 'xshop/express', '快递公司管理', 'fa fa-list', '', '', 1, 1567646753, 1567646753, 0, 'normal'),
(129, 'file', 128, 'xshop/express/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(130, 'file', 128, 'xshop/express/getAll', '查询所有快递公司', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(131, 'file', 128, 'xshop/express/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(132, 'file', 128, 'xshop/express/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(133, 'file', 128, 'xshop/express/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(134, 'file', 128, 'xshop/express/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646753, 1567646753, 0, 'normal'),
(135, 'file', 85, 'xshop/service_tag', '服务标签管理', 'fa fa-list', '', '', 1, 1567646754, 1567646754, 0, 'normal'),
(136, 'file', 135, 'xshop/service_tag/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(137, 'file', 135, 'xshop/service_tag/add', '添加', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(138, 'file', 135, 'xshop/service_tag/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(139, 'file', 135, 'xshop/service_tag/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(140, 'file', 135, 'xshop/service_tag/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(141, 'file', 85, 'xshop/hook', '钩子管理', 'fa fa-list', '', '', 1, 1567646754, 1567646754, 0, 'normal'),
(142, 'file', 141, 'xshop/hook/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(143, 'file', 141, 'xshop/hook/addons', '查看行为', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(144, 'file', 141, 'xshop/hook/reload', '重载钩子', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(145, 'file', 141, 'xshop/hook/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(146, 'file', 141, 'xshop/hook/multi', '行为开启/关闭', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(147, 'file', 85, 'xshop/launch_log', '应用启动日志', 'fa fa-list', '', '', 1, 1567646754, 1567646754, 0, 'normal'),
(148, 'file', 147, 'xshop/launch_log/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(149, 'file', 85, 'xshop/app_update', 'APP版本更新', 'fa fa-list', '', '', 1, 1567646754, 1567646754, 0, 'normal'),
(150, 'file', 149, 'xshop/app_update/index', '查看', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(151, 'file', 149, 'xshop/app_update/add', '新增', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(152, 'file', 149, 'xshop/app_update/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(153, 'file', 149, 'xshop/app_update/del', '删除', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal'),
(154, 'file', 149, 'xshop/app_update/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1567646754, 1567646754, 0, 'normal');
...
(18, 'xshop_h5_appid', 'basic', '公众号APPID', '', 'string', '', '', '', ''),
(19, 'xshop_h5_AppSecret', 'basic', '公众号AppSecret', '', 'string', '', '', '', ''),
(20, 'xshop_wx_mp_appid', 'basic', '微信小程序APPID', '', 'string', '', '', '', ''),
(21, 'xshop_wx_mp_AppSecret', 'basic', '微信小程序AppSecret', '', 'string', '', '', '', ''),
(22, 'xshop_tt_mp_appid', 'basic', '头条小程序APPID', '', 'string', '', '', '', ''),
(23, 'xshop_tt_mp_AppSecret', 'basic', '头条小程序AppSecret', '', 'string', '', '', '', ''),
(24, 'xshop_tt_mp_mchid', 'basic', '头条小程序商户ID', '', 'string', '', '', '', ''),
(25, 'xshop_tt_mp_app_id', 'basic', '头条小程序支付app_id', '', 'string', '', '', '', ''),
(26, 'xshop_tt_mp_pay_secret', 'basic', '头条小程序支付Secret', '', 'string', '', '', '', '');
...
--
-- Table structure for table `fa_xshop_address`
--

DROP TABLE IF EXISTS `fa_xshop_address`;
CREATE TABLE `fa_xshop_address` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_advance_pay`
--

DROP TABLE IF EXISTS `fa_xshop_advance_pay`;
CREATE TABLE `fa_xshop_advance_pay` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_app_update`
--

DROP TABLE IF EXISTS `fa_xshop_app_update`;
CREATE TABLE `fa_xshop_app_update` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_cart`
--

DROP TABLE IF EXISTS `fa_xshop_cart`;
CREATE TABLE `fa_xshop_cart` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_category`
--

DROP TABLE IF EXISTS `fa_xshop_category`;
CREATE TABLE `fa_xshop_category` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_delivery_rule`
--

DROP TABLE IF EXISTS `fa_xshop_delivery_rule`;
CREATE TABLE `fa_xshop_delivery_rule` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_delivery_rule_area`
--

DROP TABLE IF EXISTS `fa_xshop_delivery_rule_area`;
CREATE TABLE `fa_xshop_delivery_rule_area` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_delivery_tpl`
--

DROP TABLE IF EXISTS `fa_xshop_delivery_tpl`;
CREATE TABLE `fa_xshop_delivery_tpl` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_express`
--

DROP TABLE IF EXISTS `fa_xshop_express`;
CREATE TABLE `fa_xshop_express` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_favorite`
--

DROP TABLE IF EXISTS `fa_xshop_favorite`;
CREATE TABLE `fa_xshop_favorite` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL COMMENT '用户',
  `product_id` int(10) UNSIGNED DEFAULT NULL COMMENT '商品',
  `create_time` int(10) DEFAULT NULL COMMENT '创建时间'
...
--
-- Table structure for table `fa_xshop_history`
--

DROP TABLE IF EXISTS `fa_xshop_history`;
CREATE TABLE `fa_xshop_history` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL COMMENT '用户',
  `product_id` int(10) UNSIGNED DEFAULT NULL COMMENT '商品',
  `create_time` int(10) DEFAULT NULL COMMENT '创建时间',
...
--
-- Table structure for table `fa_xshop_hook`
--

DROP TABLE IF EXISTS `fa_xshop_hook`;
CREATE TABLE `fa_xshop_hook` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `fa_xshop_hook`
--

INSERT INTO `fa_xshop_hook` (`id`, `group`, `hook`, `hook_desc`, `group_sort`, `hook_sort`, `payload`) VALUES
(1, '商品', 'xshop_product_view', '用户浏览商品', 1, 1, 'UserModel $user, ProductModel $product'),
(2, '购物车', 'xshop_cart_add_after', '加入购物车后', 1, 1, ''),
(3, '购物车', 'xshop_cart_update_after', '购物车更新后', 1, 1, ''),
(4, '用户', 'xshop_get_userinfo', '输出用户信息前', 1, 1, 'Array $user:用户基本信息($this->auth->getUserInfo()获得)'),
(5, '用户', 'xshop_user_review_before', '用户评价商品前', 1, 1, 'Auth $user\\n OrderProductModel $orderProduct:(OrderModel order, <list> ReviewModel reviews) \\n ReviewModel $review'),
(6, '用户', 'xshop_user_review_after', '用户评价商品后', 1, 1, 'Auth $user\\n OrderProductModel $orderProduct:(OrderModel order, <list> ReviewModel reviews) \\n ReviewModel $review'),
(7, '订单', 'xshop_order_before_create_response', '输出创建订单数据前', 1, 1, ''),
(8, '订单', 'xshop_order_create_after', '订单创建后', 1, 1, 'OrderModel $order'),
(9, '订单', 'xshop_order_received_before', '订单收货前', 1, 1, 'OrderModel $order, Auth $user'),
(10, '订单', 'xshop_order_received_after', '订单收货后', 1, 1, 'OrderModel $order, Auth $user'),
(11, '订单', 'xshop_order_cancel_before', '订单取消前', 1, 1, 'OrderModel $order, Auth $user'),
(12, '订单', 'xshop_order_cancel_after', '订单取消后', 1, 1, 'OrderModel $order, Auth $user'),
(13, '订单', 'xshop_order_delete_before', '订单删除前', 1, 1, 'OrderModel $order, Auth $user'),
(14, '订单', 'xshop_order_delete_after', '订单删除后', 1, 1, 'OrderModel $order, Auth $user'),
(15, '订单', 'xshop_order_pay_ok', '订单支付后', 1, 1, 'OrderModel $order');

-- --------------------------------------------------------

--
-- Table structure for table `fa_xshop_hook_addons`
--

DROP TABLE IF EXISTS `fa_xshop_hook_addons`;
CREATE TABLE `fa_xshop_hook_addons` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `fa_xshop_hook_addons`
--

INSERT INTO `fa_xshop_hook_addons` (`id`, `class_name`, `class_desc`, `addon_name`, `sort`, `hook`, `addon_title`, `status`) VALUES
(1, 'addons\\xshop\\behavior\\product\\RecodeHistory', '记录用户浏览记录', 'xshop', 10, 'xshop_product_view', 'XShop商城', 1),
(2, 'addons\\xshop\\behavior\\user\\UpdateProductReview', '更新评价数量', 'xshop', 10, 'xshop_user_review_after', 'XShop商城', 1),
(3, 'addons\\xshop\\behavior\\order\\PayOkListener', '更新库存和销量', 'xshop', 10, 'xshop_order_pay_ok', 'XShop商城', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fa_xshop_launch_log`
--

DROP TABLE IF EXISTS `fa_xshop_launch_log`;
CREATE TABLE `fa_xshop_launch_log` (
  `id` int(10) UNSIGNED NOT NULL,
  `platform` varchar(20) NOT NULL COMMENT '来源',
  `user_id` int(10) UNSIGNED DEFAULT NULL COMMENT '用户',
  `systeminfo` text DEFAULT NULL COMMENT '系统信息',
  `create_time` int(10) DEFAULT NULL COMMENT '创建时间',
  `delete_time` int(10) DEFAULT NULL,
...
--
-- Table structure for table `fa_xshop_nav`
--

DROP TABLE IF EXISTS `fa_xshop_nav`;
CREATE TABLE `fa_xshop_nav` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL COMMENT '标题',
...
--
-- Table structure for table `fa_xshop_order`
--

DROP TABLE IF EXISTS `fa_xshop_order`;
CREATE TABLE `fa_xshop_order` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_order_product`
--

DROP TABLE IF EXISTS `fa_xshop_order_product`;
CREATE TABLE `fa_xshop_order_product` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_product`
--

DROP TABLE IF EXISTS `fa_xshop_product`;
CREATE TABLE `fa_xshop_product` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_product_attr`
--

DROP TABLE IF EXISTS `fa_xshop_product_attr`;
CREATE TABLE `fa_xshop_product_attr` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_product_sku`
--

DROP TABLE IF EXISTS `fa_xshop_product_sku`;
CREATE TABLE `fa_xshop_product_sku` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_review`
--

DROP TABLE IF EXISTS `fa_xshop_review`;
CREATE TABLE `fa_xshop_review` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED DEFAULT NULL COMMENT '用户',
  `order_id` int(10) UNSIGNED DEFAULT NULL COMMENT '订单',
  `product_id` int(10) UNSIGNED DEFAULT NULL COMMENT '商品',
...
--
-- Table structure for table `fa_xshop_service_tag`
--

DROP TABLE IF EXISTS `fa_xshop_service_tag`;
CREATE TABLE `fa_xshop_service_tag` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_unit`
--

DROP TABLE IF EXISTS `fa_xshop_unit`;
CREATE TABLE `fa_xshop_unit` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `fa_xshop_vendor`
--

DROP TABLE IF EXISTS `fa_xshop_vendor`;
CREATE TABLE `fa_xshop_vendor` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Indexes for table `fa_xshop_address`
--
ALTER TABLE `fa_xshop_address`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `fa_xshop_advance_pay`
--
ALTER TABLE `fa_xshop_advance_pay`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_app_update`
--
ALTER TABLE `fa_xshop_app_update`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_cart`
--
ALTER TABLE `fa_xshop_cart`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_category`
--
ALTER TABLE `fa_xshop_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_delivery_rule`
--
ALTER TABLE `fa_xshop_delivery_rule`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_delivery_rule_area`
--
ALTER TABLE `fa_xshop_delivery_rule_area`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_delivery_tpl`
--
ALTER TABLE `fa_xshop_delivery_tpl`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_express`
--
ALTER TABLE `fa_xshop_express`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_favorite`
--
ALTER TABLE `fa_xshop_favorite`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_history`
--
ALTER TABLE `fa_xshop_history`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_hook`
--
ALTER TABLE `fa_xshop_hook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_hook_addons`
--
ALTER TABLE `fa_xshop_hook_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_launch_log`
--
ALTER TABLE `fa_xshop_launch_log`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_nav`
--
ALTER TABLE `fa_xshop_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_order`
--
ALTER TABLE `fa_xshop_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_sn_UNIQUE` (`order_sn`),
  ADD KEY `order_sn` (`order_sn`);

--
-- Indexes for table `fa_xshop_order_product`
--
ALTER TABLE `fa_xshop_order_product`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_product`
--
ALTER TABLE `fa_xshop_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `index2` (`id`);

--
-- Indexes for table `fa_xshop_product_attr`
--
ALTER TABLE `fa_xshop_product_attr`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_product_sku`
--
ALTER TABLE `fa_xshop_product_sku`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_review`
--
ALTER TABLE `fa_xshop_review`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_service_tag`
--
ALTER TABLE `fa_xshop_service_tag`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_unit`
--
ALTER TABLE `fa_xshop_unit`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `fa_xshop_vendor`
--
ALTER TABLE `fa_xshop_vendor`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fa_xshop_address`
--
ALTER TABLE `fa_xshop_address`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_advance_pay`
--
ALTER TABLE `fa_xshop_advance_pay`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_app_update`
--
ALTER TABLE `fa_xshop_app_update`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_cart`
--
ALTER TABLE `fa_xshop_cart`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_category`
--
ALTER TABLE `fa_xshop_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_delivery_rule`
--
ALTER TABLE `fa_xshop_delivery_rule`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_delivery_rule_area`
--
ALTER TABLE `fa_xshop_delivery_rule_area`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_delivery_tpl`
--
ALTER TABLE `fa_xshop_delivery_tpl`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_express`
--
ALTER TABLE `fa_xshop_express`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_favorite`
--
ALTER TABLE `fa_xshop_favorite`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_history`
--
ALTER TABLE `fa_xshop_history`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_hook`
--
ALTER TABLE `fa_xshop_hook`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `fa_xshop_hook_addons`
--
ALTER TABLE `fa_xshop_hook_addons`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `fa_xshop_launch_log`
--
ALTER TABLE `fa_xshop_launch_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_nav`
--
ALTER TABLE `fa_xshop_nav`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_order`
--
ALTER TABLE `fa_xshop_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_order_product`
--
ALTER TABLE `fa_xshop_order_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_product`
--
ALTER TABLE `fa_xshop_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_product_attr`
--
ALTER TABLE `fa_xshop_product_attr`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_product_sku`
--
ALTER TABLE `fa_xshop_product_sku`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_review`
--
ALTER TABLE `fa_xshop_review`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_service_tag`
--
ALTER TABLE `fa_xshop_service_tag`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_unit`
--
ALTER TABLE `fa_xshop_unit`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fa_xshop_vendor`
--
ALTER TABLE `fa_xshop_vendor`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
